...
.card-header .icon-wrapper {
  position: absolute;
  top: -1rem; /* Ajusta esta medida para que el círculo sobresalga adecuadamente */
  left: 50%;
  transform: translateX(-50%);
  width: 3rem; /* Tamaño del círculo */
  height: 3rem; /* Tamaño del círculo */
  background-color: #fff; /* Color de fondo del círculo */
  border: 3px solid #ddd; /* Grosor y color del borde del círculo */
  border-radius: 50%; /* Redondea el borde para formar un círculo */
  display: flex;
  align-items: center;
...
.card-header {
  padding-top: 2rem; /* Asegúrate de que haya suficiente espacio para el círculo en la parte superior */
...
.card-menu {
  min-height: 170px; /* Ajusta este valor al que prefieras */
...
.card-container {
  ...
  flex-wrap: nowrap;
  overflow-x: auto;
  gap: 15px; /* Espacio entre las tarjetas, ajusta según tu diseño */
}
...
<div class="container mt-2 p-4" style="max-height: 450px; overflow-y: auto; ">
  <div class="row" >
    <!-- Card 1 -->
    <div class="col-6 col-md-4 col-lg-3">
      <div class="card mb-4 shadow-sm card-menu ">
        ...
        <div class="card-body">
          <!-- <h5 class="card-title">Add Entradas</h5> -->
          <p class="card-text text-center">Add Entradas</p>
        </div>
      </div>
    </div>
    <!-- ...other cards... -->
