<ul><li class='nav-item'>
                        <a class='nav-link' href='/inicio'>
                            <i class='icon'><svg width='20' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' class='icon-20'>
                        ...
                        <a class='nav-link' data-bs-toggle='collapse' href='#menu-2' role='button' aria-expanded='false' aria-controls='menu-2'>
                            <i class='icon'>icon-acerca-de</i>
                            <span class='item-name'>opcion2</span>
                            <i class='right-icon'>
                                <svg class='icon-18' xmlns='http://www.w3.org/2000/svg' width='18' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                                    <path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 5l7 7-7 7' />
                                </svg>
                            </i>
                        </a><ul class='sub-nav collapse' id='menu-2' data-bs-parent='#sidebar-menu'><li class='nav-item'>
                            <a class='nav-link' href='/acerca-de/equipo'>
                                <i class='icon'>icon-equipo</i>
                                <span class='item-name'>submenu</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            $menuHtml="   <ul class='navbar-nav iq-main-menu' id='sidebar-menu'>
